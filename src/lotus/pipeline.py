...
class DirectDiffusionPipeline(
    ...
    def __call__(
        ...
        **kwargs,
        ...
        print(f"Embedded inherited parts step for LotusDPipeline is {inference_time:.4f} seconds using VAE")
        if not return_dict:
            return (image, has_nsfw_concept)
...
class LotusDPipeline(DirectDiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        inference_time = end - start
        print(f"Encoding step for LotusDPipeline is {inference_time:.4f} seconds using VAE")
        # 5. Denoising
        #with torch.autograd.profiler.profile(use_cuda=True) as prof:
        t = timesteps[0]
        ...
        inference_time = end - start
        #print(prof.key_averages().table(sort_by="cuda_time_total"))
        print(f"Denoising step for LotusDPipeline using U-Net is {inference_time:.4f} seconds")
        start = time.time()
        if not output_type == "latent":
        ...
        inference_time = end - start
        print(f"Decoding step for LotusDPipeline using VAE is {inference_time:.4f} seconds")
        ...
        inference_time = end - start
        print(f"Post-processing step for LotusDPipeline took {inference_time:.4f} seconds")
        ...
        returnal = StableDiffusionPipelineOutput(images=image, nsfw_content_detected=has_nsfw_concept)

        end = time.time()
        inference_time = end - start
        print(f"Call for LotusDPipeline is {inference_time:.4f} seconds using VAE")
...
class LotusGPipeline(DirectDiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        inference_time = end - start
        print(f"Encoding step for LotusGPipeline is {inference_time:.4f} seconds")
        ...
        inference_time = end - start
        print(f"Denoising step for LotusGPipeline is {inference_time:.4f} seconds with {num_inference_steps} denoising steps.")
        ...
        inference_time = end - start
        print(f"Post-processing step for LotusGPipeline is {inference_time:.4f} seconds")
